...
Model-building The two types of models you need to build are as follows:
...
Application scorecard Build an application scorecard with the good to bad odds of 10 to 1 at a score of 400 doubling every 20 points.
